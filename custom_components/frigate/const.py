...
CONF_ENABLE_SUBLABEL_SENSORS = "enable_sublabel_sensors"
CONF_ENABLE_ATTRIBUTE_SENSORS = "enable_attribute_sensors"
CONF_ENABLE_ATTRIBUTE_TRACKING = "enable_attribute_tracking"
